...
@section('content')
    <v-service-page></v-service-page>

    @pushOnce('scripts')
        <script type="text/x-template" id="v-service-page">
        ...
        <section class="pt-32 pb-20 bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden">
            ...
            <div class="absolute top-1/3 right-20 w-16 h-16 bg-indigo-500/20 rounded-full animate-float" style="animation-delay: 2s;"></div>
            <div class="absolute bottom-20 left-1/4 w-12 h-12 bg-purple-500/20 rounded-full animate-float" style="animation-delay: 4s;"></div>
            <div class="absolute top-1/2 right-1/4 w-24 h-24 bg-pink-500/10 rounded-full animate-float" style="animation-delay: 1s;"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center max-w-4xl mx-auto">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-light font-serif mb-6 leading-tight">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="#services" class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 inline-flex items-center justify-center">
                            Explore Services
                            <i class="fas fa-arrow-down ml-2 transform group-hover:translate-y-1 transition-transform"></i>
                        </a>
                        <a href="{{ route('contact') }}" class="border border-white/30 text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/5 transition-all duration-300 transform hover:-translate-y-1 inline-flex items-center justify-center">
        ...
        <section id="services" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-3xl md:text-4xl font-light font-serif text-gray-900 mb-4">Comprehensive Event Solutions</h2>
                ...
                <div class="mb-16">
                    <div class="flex flex-wrap justify-center gap-4 mb-12">
                        <button class="tab-btn bg-white border border-gray-200 px-6 py-3 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white shadow-lg" data-tab="weddings">
                    ...
                    <!-- Wedding Services -->
                    <div id="weddings" class="tab-content">
                        <div class="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 class="text-2xl md:text-3xl font-light font-serif text-gray-900 mb-6">Elegant Wedding Planning</h3>
                                ...
                                <a href="{{ route('contact') }}" class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 inline-flex items-center">
                                    Plan Your Wedding
                    ...
                    <div id="corporate" class="tab-content hidden">
                        <div class="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 class="text-2xl md:text-3xl font-light font-serif text-gray-900 mb-6">Professional Corporate Events</h3>
                    ...
                    <div id="social" class="tab-content hidden">
                        <div class="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 class="text-2xl md:text-3xl font-light font-serif text-gray-900 mb-6">Memorable Social Celebrations</h3>
                    ...
                    <!-- Destination Events -->
                    <div id="destination" class="tab-content hidden">
                        <div class="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 class="text-2xl md:text-3xl font-light font-serif text-gray-900 mb-6">Exotic Destination Events</h3>
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-3xl md:text-4xl font-light font-serif text-gray-900 mb-4">Our Seamless Process</h2>
        ...
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-3xl md:text-4xl font-light font-serif text-gray-900 mb-4">Additional Services</h2>
                    <p class="text-gray-600 text-lg">Enhance your event with our specialized add-on services</p>
                </div>

                <div class="grid md:grid-cols-3 gap-8">
                    <div class="p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-2 transition-all duration-300">
                        <div class="w-14 h-14 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl flex items-center justify-center mb-6 shadow-lg">
                    ...
                    <div class="p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-2 transition-all duration-300">
                        <div class="w-14 h-14 bg-gradient-to-br from-green-50 to-green-100 rounded-xl flex items-center justify-center mb-6 shadow-lg">
                    ...
                    <div class="p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-2 transition-all duration-300">
                        <div class="w-14 h-14 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl flex items-center justify-center mb-6 shadow-lg">
        ...
        <section class="py-20 bg-gradient-to-r from-indigo-600 to-purple-700 text-white relative overflow-hidden">
            <!-- Floating elements -->
            <div class="absolute top-10 right-10 w-24 h-24 bg-white/10 rounded-full animate-float"></div>
            <div class="absolute bottom-20 left-20 w-16 h-16 bg-indigo-500/20 rounded-full animate-float" style="animation-delay: 2s;"></div>
            <div class="absolute top-1/3 left-1/4 w-20 h-20 bg-pink-500/10 rounded-full animate-float" style="animation-delay: 1s;"></div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                <h2 class="text-3xl md:text-4xl font-light font-serif mb-6">Ready to Create Your Perfect Event?</h2>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ route('contact') }}" class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 inline-flex items-center justify-center">
        ...
        <script type="module">
window.app.component('v-service-page', {
    template: "#v-service-page",
    mounted() {
        // Tab system
